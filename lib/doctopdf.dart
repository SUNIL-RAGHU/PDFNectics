...
class DocxtopdfPage extends StatefulWidget {
  const DocxtopdfPage({Key? key}) : super(key: key);

  @override
  State<DocxtopdfPage> createState() => _DocxtopdfPagePageState();
}

class _DocxtopdfPagePageState extends State<DocxtopdfPage> {
  ...
  Future<void> compressPDF() async {
    ...
    String apiUrl = 'http://192.168.0.155:3000/api/docxtopdf';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final filePath = '${appDocDir.path}/document.pdf';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Convert TO Doc'),
          ...
          children: [
            ...
            if (selectedFile != null) ...[
              ...
              ElevatedButton(
                ...
                child:
                    isLoading ? CircularProgressIndicator() : Text('DocxToPdf'),
              ),
            ],
          ],
        ),
